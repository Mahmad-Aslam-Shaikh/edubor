...
public class NotesController {
    ...
    @PostMapping
    public ResponseEntity<?> saveNotes(@RequestBody NotesRequest notesRequest) throws ResourceNotFoundException {
        NotesResponse savedNotesResponse = notesService.saveNotes(notesRequest);
