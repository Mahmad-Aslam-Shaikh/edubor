...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public FileEntity saveFile(MultipartFile multipartFile) throws IOException, FileUploadFailedException, InvalidFileException {
    ...
    private void validateFileExtension(MultipartFile multipartFile) throws InvalidFileException {
        ...
        if (!allowedExtensions.contains(extension)) {
            throw new InvalidFileException(ExceptionMessages.UNSUPPORTED_FILE_EXTENSION_MESSAGE + extension + " Supported File extensions: "
                    + allowedExtensions);
        }
